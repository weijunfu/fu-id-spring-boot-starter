...
import io.github.weijunfu.id.codec.Decoder;
import io.github.weijunfu.id.codec.Encoder;
...
public class Hashids implements Encoder<long[], String>, Decoder<String, long[]> {
    ...
    // 默认编解码字符串
    public static final char[] DEFAULT_ALPHABET = Constant.ALPHABET62.toCharArray();
    // 默认分隔符
    ...
    public Hashids(final String salt, final String alphabet, final int minLength) {

        this(salt.toCharArray(), alphabet.toCharArray(), minLength);
    }
